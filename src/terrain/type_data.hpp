 ...
 * during the constructor, any terrains made by combining pairs of (base,
 * overlay) are lazy-created as required. The is_known() method will trigger
 * creation of the terrain if needed.
 */
